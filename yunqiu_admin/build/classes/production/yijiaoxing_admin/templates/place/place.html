...
<script>
    $(document).ready(function(){
        ...
        $("#list4").jqGrid({
            ...
            shrinkToFit:true,
            colModel:[
                {label:"场地Id",name:'placeId',index:'placeId', width:'15%',align:'center',hidden: true},
                {label:"场地名称",name:'placeName',index:'placeName', width:'35%',align:'center'},
            ...
            jsonReader:{
                id: "placeId",//设置返回参数中，表格ID的名字为blackId
        ...
        $("#btn_edit").bind("click",function(){
            ...
            if (selectedId == null){
                ...
                $("#up_placeName").val(select.placeName);
                $("#up_placeId").val(select.placeId);

                $("#update").bind("click",function(){
                    placeName = $("#up_placeName").val();

                    if(!placeName.length>0){
                        $("#vu_placeName").html("请输入场地");
                        return;
                    }
                ...
                <div class="ibox-title">
                    <form class="form-inline">
                        ...
                        <div class="form-group">
                            <label>场地</label>
                            <input type="text" id="s_placeName" name="placeName" class="form-control"/>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="myModalLabel">场地添加</h2>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-5 control-label">场地名称<span class="validt" id="va_placeName"></span></label>
...
<form id="updateForm">
    <div id="update_winfrom" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title">场地修改</h2>
                    <input type="hidden" id="up_placeId" name="placeId"/>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-5 control-label">场地名称<span class="validt" id="vu_placeName"></span></label>
                        <input type="text" id="up_placeName" name="placeName" class="form-control" />
                    </div>
