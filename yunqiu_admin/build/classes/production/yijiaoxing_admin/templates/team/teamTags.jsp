...
<script>
    $(document).ready(function(){
        ...
        $("#list4").jqGrid({
            ...
            shrinkToFit:true,
            colModel:[
                {label:"标签Id",name:'teamtagsId',index:'teamtagsId', width:'15%',align:'center',hidden: true},
                {label:"球队伍标签",name:'tagsName',index:'tagsName', width:'35%',align:'center'},
            ...
            jsonReader:{
                id: "teamtagsId",//设置返回参数中，表格ID的名字为blackId
        ...
        $("#btn_edit").bind("click",function(){
            ...
            if (selectedId == null){
                ...
                $("#up_teamtagsId").val(select.teamtagsId);
        ...
        $("#btn_delete").bind("click",function(){
            ...
            if (selectedId == null){
                ...
                $("#delete").bind("click",function(){
                    $.ajax({
                        url:"/teamtags/delTeamTags",
                        data:{
                            teamtagsId:select.teamtagsId
                        },
                        success:function(data){
                            if (data["error_code"] == 1500){
                                swal("系统错误!", data["msg"], "error");
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="myModalLabel">球队标签添加</h2>
                </div>
...
<form id="updateForm">
    <div id="update_winfrom" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title">球队标签修改</h2>
                    <input type="hidden" id="up_teamtagsId" name="teamtagsId"/>
                </div>
                <div class="modal-body">
                    <div class="form-group">
