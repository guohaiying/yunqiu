        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-5 control-label">比赛状态<span class="validt" id="va_gameStatus"></span></label>
                        <select id="gameStatus" name="gameStatus" class="form-control">
                            <option value="1">待审核</option>
                            <option value="2">待应战</option>
                            <option value="3">报名中</option>
                            <option value="4">报名结束</option>
                            <option value="5">进行中</option>
                            <option value="6">已结束</option>
                            <option value="7">已取消</option>
                            <option value="8">拒绝比赛</option>
                            <option value="9">拒绝应战</option>
                        </select>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-5 control-label">比赛状态<span class="validt" id="vu_gameStatus"></span></label>
                        <select id="up_gameStatus" name="gameStatus" class="form-control">
                            <option value="1">待审核</option>
                            <option value="2">待应战</option>
                            <option value="3">报名中</option>
                            <option value="4">报名结束</option>
