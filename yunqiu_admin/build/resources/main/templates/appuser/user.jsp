        ...
        $("#btn_edit").bind("click",function(){
            ...
            if (selectedId == null){
                ...
                $("#update").bind("click",function(){
                    ...
                    if(!stature.length>0){
                        $("#vu_stature").html("请输入身高");
                        return;
                    }

                    if(!weight.length>0){
                        $("#vu_weight").html("请输入体重");
                        return;
                    }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-5 control-label">身高<span class="validt" id="vu_stature"></span></label>
                        <input type="text" id="up_stature" name="stature" class="form-control" />
                    </div>

                    <div class="form-group">
                        <label class="col-sm-5 control-label">体重<span class="validt" id="vu_weight"></span></label>
