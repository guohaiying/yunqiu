    ...
    function teamShooterFun(){
        $("#team_shooter_list").jqGrid({
            ...
            colModel:[
                ...
                {label:"失球数",name:'createTime',index:'createTime', width:'35%',align:'center'},
                ...
                {label:"胜利场数",name:'createTime',index:'createTime', width:'35%',align:'center'},
                {label:"失败场数",name:'createTime',index:'createTime', width:'35%',align:'center'},
                {label:"平局场数",name:'createTime',index:'createTime', width:'35%',align:'center'},
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-5 control-label">失球数调整值</label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-5 control-label">胜利场数调整值</label>
                        <input type="text" id="6" name="teamName" class="form-control"/>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-5 control-label">失败场数调整值</label>
                        <input type="text" id="7" name="teamName" class="form-control"/>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-5 control-label">平局场数调整值</label>
                        <input type="text" id="8" name="teamName" class="form-control"/>
                    </div>
