...
public interface UserCloudDataMapper {
     ...
     * @param userCloudData
     */
    @Update("update pw_user_cloudData set attack_gross=#{attack_gross},defensive_gross=#{defensive_gross},physical_gross=#{physical_gross},technology_gross=#{technology_gross},aggressive_gross=#{aggressive_gross} where user_id=#{user_id}")
    int updateUserCloudData(UserCloudData userCloudData);
}
