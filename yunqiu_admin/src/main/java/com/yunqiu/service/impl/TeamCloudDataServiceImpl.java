...
public class TeamCloudDataServiceImpl implements TeamCloudDataService {
    ...
    public boolean initialization(String team_id) {
        try {
            ...
            teamCloudData.setCloud_id(Utils.getID(22));
    ...
    public boolean computeCloudDataByGame(String game_id) {
        try {
            ...
            for (int item=0;item<entire_number;item++){
                ...
                if ((int)entire_one.get("type") == 8){
                    if ((int)entire_one.get("attribution") == 1){
                        //A队射正次数
                        teamA_shotOnTarget = Integer.parseInt(entire_one.get("total_number")+"");
                    }else {
                        //B队射正次数
                        teamB_shotOnTarget = Integer.parseInt(entire_one.get("total_number")+"");
                    }
                    //获取射门次数
                }else if ((int)entire_one.get("type") == 7){
                    if ((int)entire_one.get("attribution") == 1){
                        //A队射门次数
                        teamA_shoot = Integer.parseInt(entire_one.get("total_number")+"");
                    }else {
                        //B队射门次数
                        teamB_shoot = Integer.parseInt(entire_one.get("total_number")+"");
                    }
                }else if ((int)entire_one.get("type") == 1){
                    if ((int)entire_one.get("attribution") == 1){
                        //A队进球数
                        teamA_goal = Integer.parseInt(entire_one.get("total_number")+"");
                    }else {
                        //B队进球数
                        teamB_goal = Integer.parseInt(entire_one.get("total_number")+"");
                    }
                }else if ((int)entire_one.get("type") == 13){
                    if ((int)entire_one.get("attribution") == 1){
                        //A队抢断数
                        teamA_steal = Integer.parseInt(entire_one.get("total_number")+"");
                    }else {
                        //B队抢断数
                        teamB_steal = Integer.parseInt(entire_one.get("total_number")+"");
                    }
                }else if ((int)entire_one.get("type") == 15){
                    if ((int)entire_one.get("attribution") == 1){
                        //A队扑救数
                        teamA_diving = Integer.parseInt(entire_one.get("total_number")+"");
                    }else {
                        //B队扑救数
                        teamB_diving = Integer.parseInt(entire_one.get("total_number")+"");
                    }
                }else if ((int)entire_one.get("type") == 10){
                    if ((int)entire_one.get("attribution") == 1){
                        //A队威胁传球
                        teamA_threat = Integer.parseInt(entire_one.get("total_number")+"");
                    }else {
                        //B队威胁传球
                        teamB_threat = Integer.parseInt(entire_one.get("total_number")+"");
                    }
                }else if ((int)entire_one.get("type") == 9){
                    if ((int)entire_one.get("attribution") == 1){
                        //A队过人
                        teamA_surpass = Integer.parseInt(entire_one.get("total_number")+"");
                    }else {
                        //B队过人
                        teamB_surpass = Integer.parseInt(entire_one.get("total_number")+"");
                    }
                }else if ((int)entire_one.get("type") == 9){
                    if ((int)entire_one.get("attribution") == 1){
                        //A队犯规
                        teamA_foul = Integer.parseInt(entire_one.get("total_number")+"");
                    }else {
                        //B队犯规
                        teamB_foul = Integer.parseInt(entire_one.get("total_number")+"");
                    }
                }else if ((int)entire_one.get("type") == 9){
                    if ((int)entire_one.get("attribution") == 1){
                        //A队黄牌
                        teamA_yellowCard = Integer.parseInt(entire_one.get("total_number")+"");
                    }else {
                        //B队黄牌
                        teamB_yellowCard = Integer.parseInt(entire_one.get("total_number")+"");
                    }
                }
            ...
            if (teamA_shotOnTarget != 0){
                System.out.print((new BigDecimal((float)teamA_shotOnTarget/teamA_shoot).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue())*100);
