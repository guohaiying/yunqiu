            ...
            success:function(data){
                if (data["error_code"] == 1500){
                    ...
                    $.each(eval(items), function (idx, obj) {
                        ...
                        if(obj.honorType==1){
                            honnorType="球员";
                        }else if(obj.honorType==2){
                            honnorType="球队";
                        }
                        var text = "'"+obj.honorId+"'";
                        rongyu+= ((idx+1)+'.'+obj.honorName+'      '+honnorType+'      '+obj.sorting+'      <img style="width: 56px;height: 42px;"  src="http://picture-services.b0.upaiyun.com/'+obj.imgUrl+'"/>' +'        <a href="javascript:deleteInfo('+text+')">删除</a><br/>');
                    });
                    $("#allRongYu").append(rongyu);
                }
            },error:function(){
                swal("修改失败","网络异常！");
            }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" id="allRongYu" style="margin-left: 41%">
                    </div>
