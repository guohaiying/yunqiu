        ...
        $("#btn_upPassword").bind("click",function(){
            ...
            if (selectedId == null){
                ...
                $("#updatePassword").bind("click",function(){
                    ...
                    var upPassword_password = $("#upPassword_password").val();
                    var upAgainPassword_password = $("#upAgainPassword_password").val();
                    ...
                    $("#updatePasswordForm").ajaxSubmit({
                        ...
                        success: function (data) {//请求成功后的函数
                            if (data["error_code"] == 1500){
                                ...
                                $("#updatePassword_winfrom").modal('hide');
                                swal("修改","修改成功！");
                                $("#list4").trigger("reloadGrid");
                            }
                        },
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-5 control-label">密码</label>
                        <input type="password" id="upPassword_password" name="password"/>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-5 control-label">再次输入密码</label>
                        <input type="password" id="upAgainPassword_password"/>
                    </div>
